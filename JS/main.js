...
let degréCelsius = prompt('Entrez le degré en celsius :');

if (isNaN(degréCelsius)){
    alert('veuillez entrer un degré');
    degréCelsius = prompt('Entrez le degré en celsius :');
} else {
    //convertit le degré celsius en fahrenheit
    const degréFahrenheit = degréCelsius * 9/5 + 32;
//afficher un message avec le prenom de l'utilisateur
    alert(`${degréCelsius} °C = ${degréFahrenheit} °F`);
}
